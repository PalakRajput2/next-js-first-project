    ...
    <section className="md:h-[650px] bg-gray-100 py-16 px-6 md:px-20 flex flex-col md:flex-row items-center gap-12">
      ...
      <div className="relative w-full md:w-1/2 flex justify-center">
        ...
        <button className="absolute inset-0 flex items-center justify-center">
          <div className="w-20 h-20 rounded-full bg-white shadow-lg flex items-center justify-center hover:scale-105 transition">
            <Play size={40} className="text-pink-500 fill-pink-500" />
          </div>
        </button>
      </div>
      ...
      <div className="md:w-1/2 space-y-7 ml-6">
        <h2 className="text-3xl md:text-5xl  text-gray-800 leading-snug">
